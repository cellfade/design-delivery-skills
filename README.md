...
## Work that informed the skills

- [Customer.io activation lab](https://github.com/cellfade/customerio-activation-lab): an earlier design exploration referenced for visual and presentation approaches.

These projects predate this package. They informed its practices; they were not generated by this release. Product names identify independent case-study subjects, not endorsements. Their assets are not included or relicensed here.
